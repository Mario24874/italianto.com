    ...
    <div className="fixed inset-0 z-50 flex items-start justify-center p-4 overflow-y-auto">
      ...
      <div className="relative z-10 w-full max-w-2xl glass-dark rounded-2xl border border-verde-800/40 my-6">
        <div className="flex items-center justify-between px-6 py-4 border-b border-verde-800/30">
          <h3 className="text-lg font-bold text-verde-100">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div>
            ...
            <textarea
              ...
              rows={8}
              placeholder="<h2>I saluti</h2><p>In italiano si usa <strong>ciao</strong> per salutare...</p>"
              className="w-full px-3 py-2 rounded-xl bg-verde-950/50 border border-verde-800/40 text-sm text-verde-200 font-mono placeholder:text-verde-600 focus:outline-none focus:border-verde-600 resize-y"
            />
          </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <label className="text-xs font-medium text-verde-400">Vocabolario</label>
              <button
                type="button"
                onClick={addVocab}
            ...
            <div className="space-y-2 max-h-52 overflow-y-auto pr-1">
              ...
              {form.vocabulary.length === 0 && (
                <p className="text-xs text-verde-600 text-center py-3">
                  Sin palabras. Haz clic en &ldquo;Agregar palabra&rdquo;.
                </p>
              )}
            </div>
          </div>
