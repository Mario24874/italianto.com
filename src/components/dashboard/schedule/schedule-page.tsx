    ...
    <div className="flex flex-col h-full min-h-screen bg-bg-dark">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-verde-100">Il Mio Orario di Studio</h1>
            <p className="text-xs text-verde-600 mt-0.5">
              {userName ? `Ciao ${userName}! ` : ''}Sessioni ricorrenti settimanali
            </p>
          </div>
        </div>
        <button
      ...
      <div className="flex flex-col xl:flex-row flex-1 gap-0 overflow-hidden">
        ...
        >
          {/* Summary cards */}
          <div>
            <p className="text-[10px] font-semibold text-verde-600 uppercase tracking-wider mb-3">Riepilogo Settimanale</p>
            <div className="grid grid-cols-2 xl:grid-cols-1 gap-3">
              <div className="bg-bg-dark rounded-xl border border-verde-900/30 px-4 py-3">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-[10px] text-verde-600 uppercase tracking-wide font-medium">Sessioni</span>
                </div>
                <span className="text-2xl font-bold text-verde-200">{totalSessions}</span>
                <span className="text-xs text-verde-700 ml-1">/ settimana</span>
              </div>
              <div className="bg-bg-dark rounded-xl border border-verde-900/30 px-4 py-3">
                <div className="flex items-center gap-2 mb-1">
                  <Clock size={13} className="text-verde-600" />
                  <span className="text-[10px] text-verde-600 uppercase tracking-wide font-medium">Ore totali</span>
                </div>
                <span className="text-2xl font-bold text-verde-200">{totalHours}</span>
                <span className="text-xs text-verde-700 ml-1">h / settimana</span>
              </div>
            </div>
          </div>
          ...
          {totalSessions > 0 && (
            <div>
              <div className="flex items-center gap-2 mb-3">
                ...
                <p className="text-[10px] font-semibold text-verde-600 uppercase tracking-wider">Distribuzione</p>
              </div>
          ...
          {totalSessions === 0 && (
            <div className="text-center py-8">
              ...
              <p className="text-xs text-verde-700 leading-relaxed">
                Nessuna sessione ancora.<br />
                Clicca su un orario o su<br />
