...
const TYPES = [
  { id: 'comment',         label: 'Comentario',  icon: MessageSquare, color: 'text-verde-400' },
  { id: 'bug_report',      label: 'Reporte',      icon: Bug,           color: 'text-red-400' },
  { id: 'feature_request', label: 'Sugerencia',   icon: Star,          color: 'text-amber-400' },
]
      ...
      {open && (
        <div className="fixed bottom-22 right-6 z-50 w-80 rounded-2xl border border-verde-800/50 bg-bg-dark shadow-2xl overflow-hidden">
          <div className="px-4 py-3 border-b border-verde-900/40 flex items-center justify-between">
            <span className="text-sm font-semibold text-verde-200">¿Tienes algo que decirnos?</span>
