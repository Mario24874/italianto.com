...
const translations = {
  es: {
    ...
    about: {
      ...
      p3: 'Hoy, Italianto está compuesto por tres aplicaciones integradas bajo una sola cuenta: la plataforma web, ItaliantoApp (móvil y PWA) y Dialogue Studio.',
  ...
  it: {
    ...
    about: {
      ...
      p3: "Oggi, Italianto è composto da tre applicazioni integrate sotto un unico account: la piattaforma web, ItaliantoApp (mobile e PWA) e Dialogue Studio.",
  ...
  en: {
    ...
    about: {
      ...
      p3: 'Today, Italianto consists of three integrated applications under one account: the web platform, ItaliantoApp (mobile and PWA) and Dialogue Studio.',
